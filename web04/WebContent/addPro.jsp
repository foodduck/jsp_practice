...
<body>
	...
	<div class="container">
		...
		<form action="AddProCtrl" method="post" name="frm">
			<table class="table">
				<tr>	
				...
				<tr>
					...
					<td class="item2">
						<textarea name="procom" id="procom"  cols="90" rows="10"></textarea>
					</td>
				</tr>
				<tr>	
				...
				<tr>	
					...
					<td class="item2">
						<input type="number" name="cnt" id="cnt" max="100" min="1" value="" />
					</td>
				</tr>
				<tr>	
