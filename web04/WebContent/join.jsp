...
<body>
<%
	String uid = (String) application.getAttribute("cusid");
	String bid = "";
%>
<div class="container">
	<div class="content">	
		...
		<ul class="fr_list">
			<li>
				...
				<span class="lb_data">
					<input type="text" name="cusid" id="cusid" placeholder="8~12 문자 및 숫자로 입력" maxlength="12" class="in_data" required autofocus />
			...
			<li>
				...
				<span class="lb_data">
					<input type="text" name="cusemail" id="cusemail" placeholder="@를 포함하여 입력" class="in_data" required />
			...
			<li>
				...
				<span class="lb_data">
					<input type="text" name="addr1" id="addr1" class="in_data" />
				</span>
			</li>
			<li>
				<label for="address2" class="lb">상세주소</label>
				<span class="lb_data">
					<input type="text" name="addr2" id="addr2" class="in_data" />
				</span>
			</li>
			<li>
