	...
	<%@ include file="header.jsp" %>
        ...
        <section class="content" style="background-color: #f1f1f1; padding:30px; margin:40px auto;">
			...
			<form action="LoginCtrl" method="post" class="frm" id="frm1">
				<fieldset>
					<input type="text" class="indata" id="cusid" name="cusid" placeholder="아이디 입력" autofocus required /><br><br>
					<input type="password" class="indata" id="cuspw" name="cuspw" placeholder="비밀번호 입력" required /><br>
					<br /><br />
