...
public class GetCustomListCtrl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<CustomVO> cusList = dao.getCustomList();
		
		request.setAttribute("cusList", cusList);	//보낼 객체를 선언
		RequestDispatcher view = request.getRequestDispatcher("getCustomList.jsp");	//보내질 곳 선언
